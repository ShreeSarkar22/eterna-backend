...
```
Client Request → Rate Limiter → Controller → Aggregation Service
                                                    ↓
                                            Check Cache
                                                    ↓
...
WebSocket Updates: Background job → Check changes → Broadcast to clients
```
...
**Demo Video**: https://www.youtube.com/watch?v=PMm89Et5Xio
